    ...
    <div className={`p-8 rounded-3xl ${cardBg} border ${borderColor} shadow-xl backdrop-blur-md flex flex-col items-center justify-center text-center relative overflow-hidden group hover:shadow-2xl transition-all duration-300 min-h-[380px]`}>
      ...
      <div className="my-6 relative flex items-center justify-center gap-4 cute-floating select-none">
        ...
        <div className="relative flex flex-col items-center">
          <span className="text-7xl md:text-8xl font-molle text-transparent bg-clip-text bg-gradient-to-r from-rose-600 via-pink-600 to-amber-500 select-none drop-shadow-[0_4px_8px_rgba(244,63,94,0.15)] filter tracking-tight">
